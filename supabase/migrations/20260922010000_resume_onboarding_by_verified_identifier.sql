...
BEGIN
  IF p_identifier_type NOT IN ('phone', 'email')
  ...
  SELECT count(*)::integer INTO v_match_count
   ...
   WHERE identifier.identifier_type = p_identifier_type
...
REVOKE ALL ON FUNCTION public.resume_onboarding_by_verified_identifier(text, text, text, text)
FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.resume_onboarding_by_verified_identifier(text, text, text, text)
TO service_role;
